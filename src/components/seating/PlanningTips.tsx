...
const PlanningTips: Component = () => {
  return (
    <div class="animate-fade-in-up-delay-200 mt-4 sm:mt-6 p-3 sm:p-4 bg-gradient-to-r from-blue-50/50 to-cyan-50/50 rounded-lg border border-blue-100/50">
      <div class="flex items-start space-x-3">
        ...
        <div class="text-sm flex-1">
          ...
          <ul class="text-blue-700 font-light space-y-1 text-xs leading-relaxed">
