...
function GuestList(props) {
  // Don't destructure props here!
  const [showAddForm, setShowAddForm] = createSignal(false);
  const [editingGuest, setEditingGuest] = createSignal(null);
  ...
  const updatePlusOne = (plusOneId, field, value) => {
    setFormData((prev) => ({
      ...prev,
  ...
  const stats = () => {
    const guests = props.guests; // Access props.guests instead of destructured guests
    ...
    const totalAttendees = attending.reduce(
      (sum, guest) => sum + 1 + guest.plus_ones,
      0
    );
          ...
          <form onSubmit={handleSubmit} class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  value={formData().name}
                  onInput={(e) => updateFormField("name", e.target.value)}
              ...
              <div>
                ...
                <input
                  ...
                  onInput={(e) => updateFormField("email", e.target.value)}
                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onInput={(e) => updateFormField("phone", e.target.value)}
                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateFormField("rsvp_status", e.target.value)
                  }
                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onInput={(e) =>
                    updateFormField("meal_preference", e.target.value)
                  }
                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                      ...
                      <div class="space-y-2">
                        <div>
                          ...
                          <input
                            ...
                            value={plusOne.name}
                            onInput={(e) =>
                              updatePlusOne(plusOne.id, "name", e.target.value)
                            }
                        ...
                        <div>
                          ...
                          <textarea
                            value={plusOne.notes}
                            onInput={(e) =>
                              updatePlusOne(plusOne.id, "notes", e.target.value)
                            }
                            class="w-full px-2 py-1 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-purple-500"
                            rows="2"
            ...
            <div>
              ...
              <textarea
                ...
                onInput={(e) => updateFormField("notes", e.target.value)}
            ...
            >
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm">
                ...
                <div class="flex items-center text-gray-600">
                  ...
                  <span>
                    Total: {1 + (guest.plus_ones?.length || 0)} attendee
                    {1 + (guest.plus_ones?.length || 0) > 1 ? "s" : ""}
                  </span>
                </div>
              </div>
